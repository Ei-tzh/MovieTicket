                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control float-right" id="date" name="show_date">
                                    </div>
                                    @error('show_date')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control float-right" id="time" name="show_time">
                                    </div>
                                   @error('show_time')
                                        <small id="bodyhelp" class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                            ...
                                            @foreach($movies as $movie)
                                                @foreach($theaters as $theater)
                                                    @if($movie_theater->movie_id == $movie->id && $movie_theater->theater_id == $theater->id)
                                                        ...
                                                        <option value="{{ $movie_theater->id}}">{{ $movie->name.' - '.$theater->name.'( '.$theater->cinema->name.' )'}}</option>
